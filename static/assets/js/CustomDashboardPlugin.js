 ...
 * Comprehensive marine research dashboard with interactive widgets
 */
...
window.addEventListener("QWC2ApiReady", () => {
                        ...
                        this.renderWidget(
                            ...
                            React.createElement('div', {
                                ...
                                React.createElement('div', null,
                                    ...
                                    React.createElement('div', {
                                        style: { fontSize: '14px', color: '#4CAF50', marginTop: '5px' }
                        ...
                        this.renderWidget(
                            ...
                            React.createElement('div', {
                                ...
                                React.createElement('div', null,
                                    ...
                                    React.createElement('div', {
                                        style: { fontSize: '14px', color: '#FF9800', marginTop: '5px' }
                        ...
                        this.renderWidget(
                            ...
                            React.createElement('div', null,
                                React.createElement('div', {
                                    ...
                                    React.createElement('div', {
                                        style: { fontSize: '32px', fontWeight: 'bold', color: '#9C27B0' }
                            ...
                            React.createElement('div', {
                                ...
                                ...this.state.widgets.recentActivity.map((activity, index) =>
                                    React.createElement('div', {
                                        ...
                                        React.createElement('div', {
                                            style: { fontSize: '14px', color: '#333', marginBottom: '2px' }
                                        }, activity.action),
                                        React.createElement('div', {
                                            style: { fontSize: '12px', color: '#9C27B0' }
                                        }, activity.location)
                                    )
                                )
                            )
    ...
    window.qwc2.addPlugin("CustomDashboardPlugin", CustomDashboardPlugin);
});
